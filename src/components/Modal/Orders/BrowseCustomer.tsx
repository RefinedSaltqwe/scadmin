...
const BrowseCustomer:React.FC<BrowseCustomerProps> = (props) => {
                ...
                <Fade in={open.open}>
                    <Box sx={{
                        ...
                        <FlexBetween sx={{flexDirection: "row"}}>
                            <Typography variant="h5" sx={{fontWeight: 700, mb: 2, width: "100%"}}>Customer</Typography>
                            <Divider/>
                                <Box sx={{width: "100%", display: "flex", justifyContent: "end", flexDirection: "column"}}>
                                    <AlertInfo text="Add customer." />
                                    <Box sx={{flexGrow: 1}}>
