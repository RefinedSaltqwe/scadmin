    ...
    return (
        <FlexBetween sx={{height: "100%", justifyContent: "center"}}>
            <FlexBetween sx={{flexDirection: "column"}}>
                <Box sx={{mb: 6}}>
                    <Image
                        src="/assets/img/error-401.png"
                        alt="Picture of the author"
                        width={300}
                        height={300}
                    />
                </Box>
                <Typography variant="h3" sx={{color: theme.palette.text.primary, fontWeight: 700, textAlign: "center"}} >401: Authorization required</Typography>
