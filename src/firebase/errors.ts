export const FIREBASE_ERRORS = {
    ...
    "Firebase: Error (auth/missing-email).": "Email does not exist.",
    "Error: Sorry, you are already connected to this user. Try another.": "Sorry, you are already connected to this user. Try another."
  };
